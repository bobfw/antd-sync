...
>
> 从 `@formily/antd-v5` 迁移？在 `package.json` 中加入以下配置，无需修改任何 import：
>
> ```json
...
<img src="https://img.shields.io/npm/dt/formily-antd-sync"/>
<img src="https://img.shields.io/npm/dm/formily-antd-sync"/>
<a href="https://www.npmjs.com/package/formily-antd-sync"><img src="https://img.shields.io/npm/v/formily-antd-sync.svg"></a>
